...
export function MarketingHero({ memberCtaHref }: MarketingHeroProps) {
  return (
    ...
    >
      <div className="mb-[var(--u-s-8)] flex flex-wrap items-center gap-[14px] font-[var(--u-label)] uppercase tracking-[0.16em] text-[var(--u-ink-3)] sm:mb-[var(--u-s-10)]">
        <span>Vol. II · 2026</span>
        <span className="h-px w-6 bg-[var(--u-rule-2)]" aria-hidden />
        <span>Jean-Paul French philosopher</span>
      </div>
      ...
      >
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:justify-end">
          <Link
            href={memberCtaHref}
            className={cn(ctaBase, "bg-[var(--u-ink)] text-[var(--u-bg)]")}
          >
            Гишүүн болох
          ...
          <Link
            ...
            className={cn(
              ctaBase,
              "border border-[var(--u-rule-2)] bg-[var(--u-surface-2)] text-[var(--u-ink)]"
            )}
          >
            Үйлчилгээ үзэх
          </Link>
